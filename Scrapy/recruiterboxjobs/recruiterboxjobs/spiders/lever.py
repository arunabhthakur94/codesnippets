...
class crawlLever(scrapy.Spider):
    name = 'leverscraper'
    start_urls = ['file:///home/arunabh/codebase/Project/Scrapy/recruiterboxjobs/recruiterboxjobs/lever/level1Crawl/innerpage1.html']
    ...
    def parse(self, response):
        ...
        go_next = 'file:///home/arunabh/codebase/Project/Scrapy/recruiterboxjobs/recruiterboxjobs/lever/level1Crawl/innerpage'+str(crawlLever.next_job)+'.html'
        yield response.follow(go_next, callback = self.parse)
